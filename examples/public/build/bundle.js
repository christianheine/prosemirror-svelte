...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 103, 0, 2918);

    			dispose = [
    				listen_dev(div, "focus", /*focus_handler*/ ctx[14], false, false, false),
    				listen_dev(div, "blur", /*blur_handler*/ ctx[15], false, false, false),
    				listen_dev(div, "keydown", /*keydown_handler*/ ctx[16], false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ProsemirrorEditor> was created with unknown prop '${key}'`);
    	});
    ...
    /* examples/src/components/PlainTextEditor.svelte generated by Svelte v3.16.7 */
    ...
    function create_fragment$1(ctx) {
    	...
    	function prosemirroreditor_editor_binding(value) {
    		/*prosemirroreditor_editor_binding*/ ctx[9].call(null, value);
    	}

    	function prosemirroreditor_focus_binding(value_1) {
    		/*prosemirroreditor_focus_binding*/ ctx[10].call(null, value_1);
    	}
    	...
    	if (/*editor*/ ctx[0] !== void 0) {
    		prosemirroreditor_props.editor = /*editor*/ ctx[0];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			dispose = [
    				...
    				listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*focusEditor*/ ctx[1])) /*focusEditor*/ ctx[1].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!updating_editor && dirty & /*editor*/ 1) {
    				...
    				prosemirroreditor_changes.editor = /*editor*/ ctx[0];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const resetEditor = event => {
    		$$invalidate(2, editorState = getEditorState());
    		focusEditor();
    	};

    	const selectAllText = event => {
    		$$invalidate(2, editorState = selectAll$1(editorState));
    		focusEditor();
    	};
    ...
    /* examples/src/components/RichTextEditor_101.svelte generated by Svelte v3.16.7 */
    ...
    function create_fragment$2(ctx) {
    	...
    	function prosemirroreditor_focus_binding(value) {
    		/*prosemirroreditor_focus_binding*/ ctx[8].call(null, value);
    	}
...
<p><b>Ctrl-Shift-1,2,3...</b> will set the block type to heading 1,2,3...</p>`;
    ...
    /* examples/src/components/RichTextEditor_102.svelte generated by Svelte v3.16.7 */
    ...
    function create_if_block(ctx) {
    	let pre;
    	let t_value = JSON.stringify(toJSON(/*editorState*/ ctx[2]), null, 2) + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*editorState*/ 4 && t_value !== (t_value = JSON.stringify(toJSON(/*editorState*/ ctx[2]), null, 2) + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$3(ctx) {
    	...
    	let t16_value = (/*activeMarks*/ ctx[3] && /*activeMarks*/ ctx[3].length
    	? /*activeMarks*/ ctx[3].toString()
    	: "none") + "";
    	...
    	function prosemirroreditor_focus_binding(value) {
    		/*prosemirroreditor_focus_binding*/ ctx[14].call(null, value);
    	}
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isBold*/ ctx[5]) return create_if_block_1;
    		return create_else_block;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = /*showEditorState*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			input.checked = /*showEditorState*/ ctx[1];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if ((!current || dirty & /*activeMarks*/ 8) && t16_value !== (t16_value = (/*activeMarks*/ ctx[3] && /*activeMarks*/ ctx[3].length
    			? /*activeMarks*/ ctx[3].toString()
    			: "none") + "")) set_data_dev(t16, t16_value);

    			if (!current || dirty & /*activeBlockType*/ 16) set_data_dev(t20, /*activeBlockType*/ ctx[4]);

    			if (dirty & /*showEditorState*/ 2) {
    				input.checked = /*showEditorState*/ ctx[1];
    			}

    			if (/*showEditorState*/ ctx[1]) {
    				if (if_block1) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function resetEditor(event) {
    		$$invalidate(2, editorState = createRichTextEditor(html));
    		focusEditor();
    	}

    	function handleToggleBold(event) {
    		$$invalidate(2, editorState = toggleMark$1(editorState, "strong"));
    	}

    	function handleSetBlockType(type, attrs = null) {
    		return function (event) {
    			$$invalidate(2, editorState = setBlockType$1(editorState, type, attrs));
    		};
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("focusEditor" in $$props) $$invalidate(0, focusEditor = $$props.focusEditor);
    		if ("showEditorState" in $$props) $$invalidate(1, showEditorState = $$props.showEditorState);
    		if ("editorState" in $$props) $$invalidate(2, editorState = $$props.editorState);
    		if ("currentMarks" in $$props) $$invalidate(11, currentMarks = $$props.currentMarks);
    		if ("activeMarks" in $$props) $$invalidate(3, activeMarks = $$props.activeMarks);
    		...
    		if ("isBold" in $$props) $$invalidate(5, isBold = $$props.isBold);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*currentMarks*/ 2048) {
    			 $$invalidate(3, activeMarks = currentMarks
    		...
    		if ($$self.$$.dirty & /*currentMarks*/ 2048) {
    			 $$invalidate(5, isBold = currentMarks && currentMarks.activeMarks && currentMarks.activeMarks.strong);
    		}
    	};
    ...
    /* examples/src/components/RichTextEditor_103.svelte generated by Svelte v3.16.7 */
    ...
    function create_fragment$4(ctx) {
    	...
    	function prosemirroreditor_focus_binding(value) {
    		/*prosemirroreditor_focus_binding*/ ctx[9].call(null, value);
    	}
    ...
    /* examples/src/components/ProsemirrorLogo.svelte generated by Svelte v3.16.7 */

    const file$5 = "examples/src/components/ProsemirrorLogo.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$5, 1, 2, 83);
    			...
    			add_location(path3, file$5, 6, 2, 555);
    			...
    			add_location(path4, file$5, 8, 2, 714);
    			...
    			add_location(path5, file$5, 11, 2, 863);
    ...
    /* examples/src/components/SvelteLogo.svelte generated by Svelte v3.16.7 */

    const file$6 = "examples/src/components/SvelteLogo.svelte";
    ...
    const file$7 = "examples/src/App.svelte";
    ...
    // (59:10) {#each Object.keys(examples) as example (example)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(option, file$7, 59, 12, 1906);
    			this.first = option;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:10) {#each Object.keys(examples) as example (example)}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	let current;
    	let dispose;
    	const prosemirrorlogo = new ProsemirrorLogo({ $$inline: true });
    	const sveltelogo = new SvelteLogo({ $$inline: true });
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			const each_value = Object.keys(/*examples*/ ctx[1]);
